     ...
     @include('admin.header')
        ...
        <div class="main-panel">
          ...
          <h2 class="font" >Edit Product</h2>
            <form action="{{route('updateproduct',$product->id)}}" method="POST" enctype="multipart/form-data" class="form_design">
            ...
            @csrf
               ...
               <div>
               <label for="product image" class="design"> Previous Image:</label> 
              <img  height ="100" width="100" src="/photo/{{$product->image}}">
               </div>
               <div>
               ...
               <input type="number" name="discount_price" placeholder="write a discount_price"  value="{{$product->discount_price}}">
               </div>
               <div>
               
               <input  class="btn btn-outline-primary button_design" type="submit" name="submit" value="Update Product">
               </div>
