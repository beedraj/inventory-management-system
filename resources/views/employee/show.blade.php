          ...
          @if(session()->has('message'))
            ...
            <table class="center">
              ...
              <th class="th_design">#</th>
                ...
                <th class="th_design">DOB</th>
                <th class="th_design">Gender</th>
                <th class="th_design">Education</th>
                <th class="th_design">Salary</th>
              ...
              <td>{{$loop->iteration}}</td>
                ...
                <td>{{ $employee->salary}}</td>
                 ...
                 <td>
                  <a class="btn btn-success" href="{{route('editemployee',$employee->id)}} ">Edit</a>
                  <form action="{{route('deleteemployee',$employee->id)}} " method="post">
                   @method('DELETE')
                    @csrf

                    
                        <button type="submit" onclick="return confirm('Are you sure to delete this')" class="btn btn-danger"></i>delete</button>
                    </form>
