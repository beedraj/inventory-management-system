     ...
     @include('admin.header')
        ...
        <div class="main-panel">
          ...
          @if(session()->has('message'))
            ...
            @endif
          <h2 class="font" >Edit Employee</h2>
            <form action="{{route('updateemployee',$employee->id)}}" method="Post" enctype="multipart/form-data" class="form_design">
                @method('Put')
            @csrf
               <div>
               <label for="product title" class="design test">Name:</label> 
               <input type="text" name="name" placeholder="write a name" value="{{$employee->name}}" >
               ...
               <input type="mobile" name="phone" placeholder="write a phone" value="{{$employee->phone}}">
               ...
               <input type="email" name="email" placeholder="write a email" value="{{$employee->email}}"  >
               ...
               <input type="text" name="address" placeholder="write a address"  value="{{$employee->address}}" >
               ...
               <input type="date" name="dob" placeholder="write a dob" value="{{$employee->dob}}">
               ...
               <div>
               <p>Gender:</p>
                    <input type="radio" name="gender" value="male" {{ ($employee->gender=="Male")? "checked" : ""}}>
               ...
               <option selected>{{$employee->education}}</option>
               ...
               <input type="number" name="salary" placeholder="write a salary" value="{{$employee->salary}}" >
               ...
               <input  class="btn btn-outline-primary button_design" type="submit" name="submit" value="Update Employee">
               </div>
